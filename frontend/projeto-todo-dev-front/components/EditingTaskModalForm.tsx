...
export default function EditingTaskModalForm({
  ...
  const handleSubmit = (e: React.FormEvent): void => {
    ...
    console.log("Putting it to API... ", JSON.stringify(taskData, null, 2));
  };

  return (
    <Modal isOpen={isOpen} onClose={() => setIsOpen(false)}>
      <form id="taskForm editing" onSubmit={handleSubmit}>
        <h2 id="modalTitle editing">Edit Task</h2>
        <input
          type="text"
          id="taskName editing"
          name="name"
